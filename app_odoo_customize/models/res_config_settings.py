...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char('System Name', help="Setup System Name,which replace Odoo",
                                  default='TiMAD', config_parameter='app_system_name')
    ...
    # 应用帮助文档
    app_doc_root_url = fields.Char('Help of topic domain', config_parameter='app_doc_root_url', default='https://timadit.com')
    ...
    def set_module_url(self):
        ...
        app_enterprise_url = config_parameter.get_param('app_enterprise_url', 'https://www.timadit.com')
